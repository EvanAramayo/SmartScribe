                                                    ...
                                                    child: FFButtonWidget(
                                                      onPressed: () async {
                                                        ...
                                                        if (selectedFiles !=
                                                            null) {
                                                          safeSetState(() =>
                                                              _model.isDataUploading_uploadData973 =
                                                                  true);
                                                          ...
                                                          if (selectedUploadedFiles
                                                              ...
                                                              downloadUrls
                                                                  ...
                                                                  selectedFiles
                                                                      .length) {
                                                            safeSetState(() {
                                                              _model.uploadedLocalFile_uploadData973 =
                                                                  selectedUploadedFiles
                                                                      .first;
                                                              _model.uploadedFileUrl_uploadData973 =
                                                                  downloadUrls
                                                                      .first;
                                                            });
                                                            showUploadMessage(
                                                        ...
                                                        if (_model.uploadedFileUrl_uploadData973 !=
                                                                '') {
                                                          logFirebaseEvent(
                                                          ...
                                                          logFirebaseEvent(
                                                            ...
                                                            parameters: {
                                                              ...
                                                              'timestamp':
                                                                  getCurrentTimestamp,
                                                              'file_url': _model
                                                                  .uploadedFileUrl_uploadData973,
                                                            },
                                                          );
                                                          logFirebaseEvent(
                                                              'Button_backend_call');

                                                          await AudioNotesRecord
                                                                  .createDoc(
                                                                      currentUserReference!)
                                                              .set(
                                                                  createAudioNotesRecordData(
                                                            userID:
                                                                currentUserUid,
                                                            status:
                                                                '\"uploaded\"',
