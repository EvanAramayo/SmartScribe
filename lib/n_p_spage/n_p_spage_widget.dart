...
/// on this page, make a pop up that has the user rate the app 0 - 5 stars
/// after the users 3rd time logging in.
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('N_P_Sarrow_back_rounded_ICN_ON_TAP');
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'How would you rate your experience with our app? Your feedback helps us improve!',
                                  textAlign: TextAlign.center,
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                              ...
                              child: InkWell(
                                ...
                                child: RatingBar.builder(
                                  onRatingUpdate: (newValue) async {
                                    ...
                                    logFirebaseEvent(
                                        'N_P_SPAGE_PAGE_RatingBar_il3qwzxy_ON_TAP');
                                    logFirebaseEvent('RatingBar_backend_call');

                                    await currentUserReference!
                                        .update(createUsersRecordData(
                                      npsRating: _model.ratingBarValue?.round(),
                                    ));
                                  ...
                                  itemCount: 5,
                                  itemPadding:
                                      EdgeInsets.fromLTRB(0.0, 0.0, 0.0, 100.0),
                                  itemSize: 40.0,
                                  glowColor:
